...
blockCommands = M.fromList $
  ...
  , ("addbibresource", mempty <$ (skipopts *> braced >>=
                                addMeta "bibliography" . splitBibs))
  , ("marginpar", (divWith ("",["marginpar"],[])) <$> (grouped block))
  ] ++ map ignoreBlocks
...
inlineCommands = M.fromList $
  ...
  , ("textrm", extractSpaces (spanWith ("",["textrm"],[])) <$> tok)
  , ("textsf", extractSpaces (spanWith ("",["textsf"],[])) <$> tok)
  , ("textup", extractSpaces (spanWith ("",["textup"],[])) <$> tok)
  , ("textit", extractSpaces emph <$> tok)
  , ("textsl", extractSpaces (spanWith ("",["textsl"],[])) <$> extractSpaces emph <$> tok)
  , ("textsc", extractSpaces smallcaps <$> tok)
  , ("textmc", extractSpaces (spanWith ("",["textmc"],[])) <$> tok)
  , ("textgt", extractSpaces (spanWith ("",["textgt"],[])) <$> tok)
  ...
  , ("backslash", lit "\\")
  , ("slash", lit "/")
  , ("textmd", extractSpaces (spanWith ("",["textmd"],[])) <$> tok)
  , ("textbf", extractSpaces strong <$> tok)
  , ("textnormal", extractSpaces (spanWith ("",["nodecor"],[])) <$> tok)
  , ("underline", (spanWith ("",["underline"],[])) <$> tok)
  , ("ldots", lit "…")
  , ("dots", lit "…")
  , ("mdots", lit "…")
  , ("sim", lit "~")
  ...
  , ("rm", extractSpaces (spanWith("",["textrm"],[])) <$> inlines)
  , ("tt", (code . stringify . toList) <$> inlines)
  , ("mc", extractSpaces (spanWith("",["textmc"],[])) <$> inlines)
  , ("gt", extractSpaces (spanWith("",["textgt"],[])) <$> inlines)
  , ("sf", extractSpaces (spanWith("",["textsf"],[])) <$> inlines)
  , ("it", extractSpaces emph <$> inlines)
  , ("sl", extractSpaces (spanWith ("",["textsl"],[])) <$> extractSpaces emph <$> inlines)
  , ("sc", extractSpaces smallcaps <$> inlines)
  , ("bf", extractSpaces strong <$> inlines)
  , ("rmfamily", extractSpaces (spanWith("",["textrm"],[])) <$> inlines)
  , ("sffamily", extractSpaces (spanWith("",["textsf"],[])) <$> inlines)
  , ("ttfamily", (code . stringify . toList) <$> inlines)
  ...
  , ("tiny", extractSpaces (spanWith ("",["tiny"],[])) <$> inlines)
  , ("scriptsize", extractSpaces (spanWith ("",["scriptsize"],[])) <$> inlines)
  , ("footnotesize", extractSpaces (spanWith ("",["footnotesize"],[])) <$> inlines)
  , ("small", extractSpaces (spanWith ("",["small"],[])) <$> inlines)
  , ("normalsize", extractSpaces (spanWith ("",["normalsize"],[])) <$> inlines)
  , ("large", extractSpaces (spanWith ("",["large"],[])) <$> inlines)
  , ("Large", extractSpaces (spanWith ("",["Large"],[])) <$> inlines)
  , ("LARGE", extractSpaces (spanWith ("",["LARGE"],[])) <$> inlines)
  , ("huge", extractSpaces (spanWith ("",["huge"],[])) <$> inlines)
  , ("Huge", extractSpaces (spanWith ("",["Huge"],[])) <$> inlines)
